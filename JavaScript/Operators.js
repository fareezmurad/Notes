...
console.log(true && true); //Returns is TRUE

//Logical OR (||)
//Returns TRUE if one of the operands is TRUE
console.log(true || false); //Returns is TRUE
...
//Returns FALSE if apply Logical AND
//Returns TRUE if apply Logical OR

//NOT(!)
let applicationRefused = !eligibleForLoan;
//Returns the opposite of eligibleForLoan
...
//Returns defaultColor because userColor is undefined(falsy)
...
console.log(message); //Returns NO. YES if read and write permissions

//Operators Precendence
let k = 2 + 3 * 4;
console.log(k); //Returns 14. BODMAS concept
